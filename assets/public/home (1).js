...
function share(){
    ...
    let timeDate =  classname[1].split('|');
    let time = timeDate[1];
    let day = timeDate[0];


    let stringToSend = "I have " + classname[0] + " on " + day + "from" + time + ".";
    document.getElementById("m").value = stringToSend;
